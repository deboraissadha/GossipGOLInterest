...
import core.*;
import java.util.*;
import static routing.MessageRouter.*;

/**
 *
 * @author SuryoDeboAyas
 */
public class DecisionEngineRouter_withoutInterest extends ActiveRouter {

	public static final String PUBSUB_NS = "DecisionEngineRouter_withoutInterest";
	...
	protected RoutingDecisionEngine_Improved decider;
	...
	public DecisionEngineRouter_withoutInterest(Settings s)
	{
		super(s);
		...
		decider = (RoutingDecisionEngine_Improved)routeSettings.createIntializedObject(
	...
	public DecisionEngineRouter_withoutInterest(DecisionEngineRouter_withoutInterest r)
	{
		super(r);
		outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
	...
	{
		return new DecisionEngineRouter_withoutInterest(this);
	}
	...
	public void changedConnection(Connection con)
	{
		...
		DecisionEngineRouter_withoutInterest otherRouter = (DecisionEngineRouter_withoutInterest)otherNode.getRouter();
		if(con.isUp())
		{
	...
	/**
	 * Called by a peer DecisionEngineRouter_withoutInterest to indicated that it already 
	...
	public RoutingDecisionEngine_Improved getDecisionEngine()
	{
		return this.decider;
	}

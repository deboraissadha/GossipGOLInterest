...
//    private Map<String, Set<String>> testinterest;
//    private String[] testinterestList;
//    private ArrayList<String> testnodeList;
    ...
    public MessageRouter(Settings s) {
       ...
       //baru
//       testinterest = new HashMap<>();
//       String[] interest = s.getCsvSetting("interest");
//       this.testinterestList = interest;
//       testnodeList = new ArrayList<>();
//       int totalNode = s.getInt("nrofHosts");
...
//       generate();
//       printGeneratedList(getHost().getAddress());
       //System.out.println(Arrays.toString(printGeneratedList(getHost().getAddress())));
        /**
...
//        Collections.shuffle(testnodeList);
//        int temp = testnodeList.size() / testinterestList.length;
//        int s = testnodeList.size() - temp*testinterestList.length;
//        int counter = 0;
//        for (int i = 0; i < testinterestList.length; i++) {
//            Set<String> nodeTemp = new HashSet<>();
//            for (int j = 0; j < temp; j++) {
//                nodeTemp.add(testnodeList.get(counter));
//                counter++;
//            }
//            testinterest.put(testinterestList[i], nodeTemp);
//            
//        }
//        if (s>0){
//            for (int i = 0; i < s; i++) {
//                Set<String> nodeTemp = testinterest.get(testinterestList[i]);
//                nodeTemp.add(testnodeList.get(counter));
//                counter++;
//                testinterest.replace(testinterestList[i], nodeTemp);
//            }
//        }
//    }
    
//    public void printGeneratedList(int idHost){
//        for (Map.Entry<String, Set<String>> entry : testinterest.entrySet()){
//            String key = entry.getKey();
//            Set<String> value = entry.getValue();
//            //System.out.println(key +" : ");
//            for(Iterator<String> iterator = value.iterator(); iterator.hasNext();){
//                String next = iterator.next();
//                if(String.valueOf(idHost).equals(next)){
//                    this.interest = key;
//                }
...
//        this.testinterest = r.testinterest;
//        this.testinterestList = r.testinterestList;
//        this.testnodeList = r.testnodeList;
     ...
     *
     * @return The host object dari protected ke public
     */
